          ...
          <Paper elevation={9} sx={{ borderRadius: 1, overflow: 'hidden' }}>
            ...
            <CardContent>
              <Typography sx={{ mb: 4 }} variant='h6'>
                Vos films à portées de doigts - Toutes les plateformes SVOD, VOD, AVOD et TV.
              </Typography>
              <Typography sx={{ mb: 4 }} variant='body2'>
                Trouvez votre film favory sur tous les plateformes de streaming, les gratuits ou les plateformes de location. 
                Netflix, Prime Video, Disney +, Pluto TV, Rakuten TV, Canal +, OQEE, ... sont chez VDTK.
              </Typography>
              <Typography sx={{ mb: 4 }} variant='body2'>
